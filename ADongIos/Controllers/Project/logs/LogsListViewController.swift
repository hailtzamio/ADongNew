...
class LogsListViewController: BaseViewController {
    ...
    func getData() {
        showLoading()
        APIClient.getLogs(id : id) { result in
            self.stopLoading()
            switch result {
...
extension LogsListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setDataLog(data: data[indexPath.row])
