...
class ListDocsIssueNoteViewController: BaseViewController, UISearchBarDelegate, LoadMoreControlDelegate {
    ...
    func getData() {
        showLoading()
        APIClient.getIssueDocs { result in
            self.stopLoading()
            switch result {
...
extension ListDocsIssueNoteViewController: UITableViewDataSource, UITableViewDelegate {
