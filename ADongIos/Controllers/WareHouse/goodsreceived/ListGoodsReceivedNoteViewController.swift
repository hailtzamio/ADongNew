...
class ListGoodsReceivedNoteViewController: BaseViewController, UISearchBarDelegate, LoadMoreControlDelegate {
    ...
    func getData() {
        showLoading()
        APIClient.getGoodsReceivedNotes { result in
            self.stopLoading()
            switch result {
...
extension ListGoodsReceivedNoteViewController: UITableViewDataSource, UITableViewDelegate {
