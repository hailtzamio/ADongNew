...
class ListGoodsIssueRequestViewController: BaseViewController, UISearchBarDelegate, LoadMoreControlDelegate {
    ...
    var removeTeamId = 0
    var id = 0
    var titleHeader = "Yêu Cầu Xuất Kho"
    ...
    func getData() {
        showLoading()
        APIClient.getGoodsIssueRequests { result in
            self.stopLoading()
            switch result {
...
extension ListGoodsIssueRequestViewController: UITableViewDataSource, UITableViewDelegate {
