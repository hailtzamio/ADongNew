...
class ListTripChooseViewController : BaseViewController, UISearchBarDelegate, LoadMoreControlDelegate {
...
//        setupHeader()
    ...
    func getData() {
        showLoading()
        APIClient.getTrips(page : page, name : "", status:  "1") { result in
            self.stopLoading()
            switch result {
...
extension ListTripChooseViewController: UITableViewDataSource, UITableViewDelegate {
